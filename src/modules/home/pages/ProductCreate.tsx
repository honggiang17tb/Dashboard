...
import { alertError } from '../../../utils/helper';
        ...
        <section className="part1">
          <div className="form-group">
            ...
            <div className="col-md-4 px-3">
              <input type="text" className="insert" placeholder="Type Vendor name to select" />
            </div>
          </div>
          <div className="form-group">
            <label className="col-md-2">
            ...
            <div className="col-md-4 px-3">
              <input
                ...
                className="insert"
                onChange={(e) => {
                  setValueCreate((prev) => ({ ...prev, name: e.target.value }));
                }}
              />
            </div>
          </div>
          <div className="form-group">
            ...
            <div className="col-md-4 px-3">
              <Select
                data={list_brand}
                onChange={(value) => {
                  setValueCreate((prev) => ({ ...prev, brand_id: value }));
                }}
          ...
          <div className="form-group">
            ...
            <div className="col-md-4 px-3">
              <Select
                data={list_condition}
                onChange={(value) => {
                  setValueCreate((prev) => ({ ...prev, condition_id: value }));
                }}
              />
          ...
          <div className="form-group">
            ...
            <div className="col-md-4 px-3">
              <input
                ...
                className="insert"
                onChange={(e) => {
                  setValueCreate((prev) => ({ ...prev, sku: e.target.value }));
                }}
              />
            </div>
          </div>
          <div className="form-group">
            ...
            <div className="col-md-8 px-3">
              <ImageUpload data={[]} setValueUpdate={setValueCreate} setFile={setFile} />
            </div>
          </div>
          <div className="form-group">
            <label className="col-md-2">
            ...
            <div className="col-md-4 px-3">
              <MultipleSelect
                ...
                onChange={(value) => {
                  setValueCreate((prev) => ({ ...prev, categories: value }));
                }}
              />
            </div>
          </div>
          <div className="form-group">
            ...
            <div className="col-md-6 px-3">  
              <TextEditor
                onBlur={(value: any) => {
                  setValueCreate((prev: any) => ({ ...prev, description: value }));
                }}
              />
            </div>
          ...
          <div className="form-group">
            ...
            <div className="col-md-4 px-3">
              <Select
                ...
                checkbox
                onChange={(value) => {
                  setValueCreate((prev) => ({ ...prev, memberships: value }));
                }}
              />
            </div>
          </div>
          ...
          <div className="form-group">
            ...
            <div className="col-md-4 px-3  d-flex align-items-center">
              <input
                ...
                onChange={(e) => {
                  setValueCreate((prev) => ({ ...prev, price: `${Number(e.target.value).toFixed(2)}` }));
                }}
              />
          ...
          <div className="form-group">
            ...
            <div className="col-md-4 px-3">
              <input
                ...
                className="insert"
                onChange={(e) => {
                  setValueCreate((prev) => ({ ...prev, quantity: e.target.value }));
                }}
              />
            </div>
          </div>
            ...
            <div className="col-md-4 px-3">
              <input
                ...
                onChange={(e) =>
                  setValueCreate({
                    ...valueCreate,
                    shipping_to_zones: [{ ...valueCreate.shipping_to_zones[0], price: e.target.value }],
                  })
                }
              />
            </div>
            ...
            <div className="col-md-3 px-3">
              <Select
                ...
                onChange={(value) =>
                  setValueCreate({
                    ...valueCreate,
                    shipping_to_zones: [{ ...valueCreate.shipping_to_zones[0], id: value }],
                  })
                }
              />
            </div>
          ...
          <div className="form-group">
            ...
            <div className="col-md-4 px-3">
              <Select
                ...
                placeholder={'Autogenerated'}
                defaultSelect={0}
                onChange={(value) => setValueCreate({ ...valueCreate, meta_desc_type: value })}
              />
            </div>
          </div>
          <div className="form-group">
            ...
            <div className="col-md-4 px-3">
              <Select
                ...
                placeholder={'Autogenerated'}
                defaultSelect={0}
                onChange={(value) => setValueCreate({ ...valueCreate, meta_description: value })}
              />
            </div>
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            ...
            <div className="col-md-4 px-3">
              <input
                type="checkbox"
                onChange={(e) =>
                  setValueCreate({ ...valueCreate, facebook_marketing_enabled: e.target.checked ? 1 : 0 })
                }
              />
            </div>
          </div>
