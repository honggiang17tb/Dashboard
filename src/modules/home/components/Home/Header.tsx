    ...
    return (
        ...
        <header>
            ...
            <div className="left_area">
                ...
                <a onClick={()=>dispatch(replace(ROUTES.user))} className='logo'><h3>Gear Focus Admin</h3></a>
                ...
                <div className="account_menu">
                    <ul className="info_account">
                        <li className="account_profile">
                            <a onClick={() => dispatch(replace(`${ROUTES.user_detail}/${state.auth.user?.profile_id}`))}>My profile</a>
                            <p>{state?.auth?.user?.login}</p>
                        </li>
                        <li>
                            <a onClick={() => setOpen(true)}> Logout</a>
                        </li>
                    </ul>
                </div>
            </div>
