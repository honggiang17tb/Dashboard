...
const InfoProduct = ({ data }: Props) => {
  ...
  const upload = async (image: any, order: any) => {
    const formData = new FormData();
    formData.append('productId', `${payload.id}`);
    formData.append('order', `${order}`);
    formData.append('images[]', image as BinaryType);
    await dispatch(fetchThunk(API_PROJECT.upload_image, 'post', formData, true, 'multipart/form-data', true));
  };
  ...
  const handleUpdate = async (e: any) => {
    ...
    const res = await dispatch(
      fetchThunk(API_PROJECT.productUpdate, 'post', formData, true, 'multipart/form-data', true),
    );
    if (res?.success && file.length) {
      setIsUpload(true);
      let i = 0;
      file.forEach(async (x: any) => {
        await upload(x.file, x.order);
        ++i;
        if (i == file.length) {
    ...
    <div className="infoProduct">
      ...
      <form onSubmit={handleUpdate}>
        <section className="part1">
          <div className="form-group">
            ...
            <div className="col-md-4 px-3">
              <input type="text" className="insert" value={getVendor(valueUpdate.vendor_id)} />
            </div>
          </div>
          <div className="form-group">
            <label className="col-md-2">
            ...
            <div className="col-md-4 px-3">
              <input
                ...
                onChange={(e) => {
                  setValueUpdate((prev: any) => ({ ...prev, name: e.target.value }));
                }}
              />
            </div>
          </div>
          <div className="form-group">
            ...
            <div className="col-md-4 px-3">
              <Select
                data={list_brand}
                onChange={(value) => {
                  setValueUpdate((prev: any) => ({ ...prev, brand_id: value }));
                }}
          ...
          <div className="form-group">
            <label className="col-md-2">
              Condition <span className="star">*</span>
            </label>
            <div className="col-md-4 px-3">
              <Select
                data={list_condition}
                ...
                defaultSelect={0}
                onChange={(value) => {
                  setValueUpdate((prev: any) => ({ ...prev, condition_id: value }));
                }}
              />
          ...
          <div className="form-group">
            ...
            <div className="col-md-4 px-3">
              <input
                ...
                onChange={(e) => {
                  setValueUpdate((prev: any) => ({ ...prev, sku: e.target.value }));
                }}
              />
            </div>
          </div>
          <div className="form-group">
            ...
            <div className="col-md-8 px-3">
              <ImageUpload data={list_images} setValueUpdate={setValueUpdate} setFile={setFile} />
            </div>
          </div>
          <div className="form-group">
            <label className="col-md-2">
            ...
            <div className="col-md-4 px-3">
              <MultipleSelect
                ...
                onChange={(value) => {
                  setValueUpdate((prev: any) => ({ ...prev, categories: value }));
                }}
              />
            </div>
          </div>
          <div className="form-group" style={{ position: 'relative' }}>
            ...
            <div className="col-md-6 px-3">
              <TextEditor
                ...
                onBlur={(value: any) => {
                  setValueUpdate((prev: any) => ({ ...prev, description: value }));
                }}
              />
            </div>
          </div>
        ...
        <section className="part2">
          ...
          <div className="form-group">
            ...
            <div className="col-md-4 px-3">
              <Select
                ...
                checkbox
                onChange={(value) => {
                  setValueUpdate((prev: any) => ({ ...prev, memberships: value }));
                }}
              />
            </div>
          </div>
          <div className="form-group">
            ...
            <div className="col-md-4 px-3 d-flex align-items-center">
              <span className="me-3" style={{ flex: 1 }}>
                Default
              </span>
          ...
          <div className="form-group">
            <label className="col-md-2">
              Price <span className="start">*</span>
            </label>
            <div className="col-md-4 px-3  d-flex align-items-center">
              <input
                type="text"
                ...
                onChange={(e) => {
                  setValueUpdate((prev: any) => ({ ...prev, price: `${Number(e.target.value).toFixed(2)}` }));
                }}
              />
              ...
              <input
                ...
                onChange={(e) =>
                  setValueUpdate((prev: any) => ({ ...prev, participate_sale: e.target.checked ? 1 : 0 }))
                }
              />
            </div>
          </div>
          <div className="form-group">
            ...
            <div className="col-md-4 px-3"></div>
          </div>
          <div className="form-group">
            <label className="col-md-2">
              Quantity in stock <span className="star">*</span>
            </label>
            <div className="col-md-4 px-3">
              <input
                type="text"
                ...
                onChange={(e) => {
                  setValueUpdate((prev: any) => ({ ...prev, quantity: e.target.value }));
                }}
              />
            </div>
          </div>
        ...
        <section className="part3">
          ...
          <div className="form-group">
            <label className="col-md-2">
              Continental U.S. <span className="star">*</span>
            </label>
            <div className="col-md-4 px-3">
              <input
                type="text"
                ...
                onChange={(e) =>
                  setValueUpdate({
                    ...valueUpdate,
                    shipping_to_zones: [{ ...valueUpdate.shipping_to_zones[0], price: e.target.value }],
                  })
                }
              />
            </div>
            ...
            <div className="col-md-3 px-3">
              <Select
                ...
                onChange={(value) => {
                  setValueUpdate({
                    ...valueUpdate,
                    shipping_to_zones: [{ ...valueUpdate.shipping_to_zones[0], id: value }],
                  });
                }}
              />
            </div>
          ...
          <div className="form-group">
            ...
            <div className="col-md-4 px-3">
              <Select
                ...
                defaultSelect={0}
                onChange={(value) => setValueUpdate({ ...valueUpdate, meta_desc_type: value })}
              />
            </div>
          </div>
          <div className="form-group">
            ...
            <div className="col-md-4 px-3">
              <Select
                data={list_MetaDescription}
                placeholder={'Autogenerated'}
                defaultSelect={0}
                onChange={(value) => setValueUpdate({ ...valueUpdate, meta_description: value })}
              />
            </div>
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            ...
            <div className="col-md-4 px-3">
              <input
                ...
                onChange={(e) =>
                  setValueUpdate({ ...valueUpdate, facebook_marketing_enabled: e.target.checked ? 1 : 0 })
                }
              />
            </div>
          </div>
        ...
        <div className="sticky-panel">
          <div className="d-flex align-items-center">
            <button disabled={disableBtn} type="submit" className="btn btn-warning">
              {isUpload ? 'Please Wait' : 'Update Product'}
            </button>
            {isUpload && <div className="spinner-border text-warning ms-3" role="status"></div>}
          </div>
        </div>
      </form>
    </div>
